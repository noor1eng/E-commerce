...
export default function SignIn() {
  ...
  //functions
  return (
    <section className=" relative isolate flex w-full flex-col items-center justify-center overflow-hidden">
      {load && <Loading />}
      <div className="relative container mx-auto flex min-h-dvh flex-col items-center justify-center px-4 py-12">
        <Card className="relative w-full max-w-lg ring-0 p-8 shadow-2xl">
          ...
          {/* Sign Up Form */}
          <form className="flex flex-col gap-6" onSubmit={hanldeSubmit}>
          ...
          {/* Sign In Link */}
          <p className="mt-3 flex justify-center gap-1 text-center text-sm">
